...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const { get } = require('got')
...
const getCountry = (city, tz) =&gt; {
  ...
  for (const c of cities) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (c.timezone === tz) {
      return c
    }
  }
<span class="cstat-no" title="statement not covered" >  return cities[0]</span>
}
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Fri Apr 26 2019 11:48:43 GMT+0200 (hora de verano de Europa central)
</div>
</div>
